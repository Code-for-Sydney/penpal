    ...
    override suspend fun execute(context: ToolExecutionContext): ToolResult {
        ...
        val history = context.conversationHistory.joinToString("\n\n") { msg ->
            val role = when (msg.role) {
                com.penpal.core.ai.tools.MessageRole.USER -> "User"
                com.penpal.core.ai.tools.MessageRole.ASSISTANT -> "Assistant"
            }
...
class ToolRegistryBuilder {
    ...
    fun withWebSearch(vectorStore: VectorStoreRepository): ToolRegistryBuilder {
        ...
        registry.register(com.penpal.core.ai.tools.web.StoreWebContentTool(vectorStore))
        registry.register(com.penpal.core.ai.tools.web.ListStoredSourcesTool(vectorStore))
        registry.register(com.penpal.core.ai.tools.web.DeleteStoredSourceTool(vectorStore))
        return this
    }
